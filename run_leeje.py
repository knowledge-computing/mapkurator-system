...
##input file : tiff and csv 
# read csv 
# change to format (tiff)
# change the path
# execute all module
...
def run_pipeline(args):
    ...
    if module_entity_linking:
        ...
        run_linker_command = 'python post_ocr_entity_linker.py --sample_map_path '+ input_csv_path +' --in_geojson_dir '+ geojson_output_dir +' --out_geojson_dir '+ geojson_linked_output_dir
